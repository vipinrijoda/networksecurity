...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        # Feature store file path - add file name
        self.feature_store_file_path: str = os.path.join(
            self.data_ingestion_dir, 
            training_pipeline.DATA_INGESTION_FEATURE_STORE_DIR,
            "feature_store.csv"  # Added file name
        )
        
        # Training file path - add file name
        self.training_file_path: str = os.path.join(
            self.data_ingestion_dir, 
            training_pipeline.DATA_INGESTION_INGESTED_DIR,
            training_pipeline.TRAIN_FILE_NAME  # Use constant from training_pipeline
        )
        
        # Testing file path - add file name
        self.testing_file_path: str = os.path.join(
            self.data_ingestion_dir, 
            training_pipeline.DATA_INGESTION_INGESTED_DIR,
            training_pipeline.TEST_FILE_NAME  # Use constant from training_pipeline
        )
        
        # ✅ UPDATED: Fixed the spelling from RATION to RATIO
